...
# Add the parent directory to sys.paths
...
def start_scan():
    ...
    # Enqueue task
    job = queue.enqueue(process_dns_scan, args=(domain, scan_id), job_timeout='1m')
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', debug=True, port=Config.PORT_DNS)
